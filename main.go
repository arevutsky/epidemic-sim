...
func main() {
	...
	incubation = flag.Int("n", 4, "how long before the cell becomes infectious")
	duration = flag.Int("d", 14, "how long the cell remains infectious")
	fatality = flag.Float64("f", 0.02, "probability of fatality")
	immunity = flag.Float64("i", 1, "how immune the cell is to infection after recovery")
	...
	qIntroduced = flag.Int("q", 20, "day when quarantine is introduced")
	qEffectiveness = flag.Float64("g", 1, "effectiveness of quarantine")
